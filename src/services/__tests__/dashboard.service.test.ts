...
// Access the mock functions from the mocked supabase client
...
describe('Dashboard Service', () => {
  ...
  describe('getRecentBidsForHandyman', () => {
    ...
    it('retrieves recent bids for handyman auctions', async () => {
      ...
      // Set up the mock to return different queries based on the table
      mockFrom.mockImplementation((table: string) => {
        ...
        // Return a default query for other tables
        return {
          select: jest.fn().mockReturnThis(),
          eq: jest.fn().mockReturnThis(),
          order: jest.fn().mockReturnThis(),
    ...
    it('returns empty array when handyman has no auctions', async () => {
      ...
      mockFrom.mockReturnValue(auctionQuery)
